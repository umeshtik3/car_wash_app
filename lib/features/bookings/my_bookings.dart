...
class _MyBookingsPageState extends State<MyBookingsPage> {
  ...
  Future<void> _loadPendingBookings() async {
    ...
    try {
      ...
      final pendingBookings = allBookings.where((booking) => 
      ...
      for (final booking in pendingBookings) {
        try {
          ...
          final selectedServices = booking['selectedServices'] as List<dynamic>? ?? [];
          
          for (final serviceId in selectedServices) {
            final service = await _serviceService.getServiceDetails(serviceId.toString());
            if (service != null) {
          ...
          // Get car details
          final carDetails = await _carService.getCurrentUserCarDetails(booking['carId']);
              ...
              : RefreshIndicator(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final serviceDetails = booking['serviceDetails'] as List<Map<String, dynamic>>;
                                ...
                                children: [
                                  Expanded(
                                    child: OutlinedButton.icon(
                                      onPressed: () => _modifyBooking(booking['id']),
                                  ...
                                  Expanded(
                                    child: ElevatedButton.icon(
                                      onPressed: () => _proceedToPayment(booking['id']),
